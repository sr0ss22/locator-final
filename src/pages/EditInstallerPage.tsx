    ...
    try {
      ...
      if (canEdit) {
        ...
        if (totalCount && totalCount > 0) {
          console.log("ACTION 2: Calling RPC to delete all territories in a single server-side transaction.");
        ...
        console.log(`ACTION 3: Saving ${territoriesToProcess.length} new territories...`);
