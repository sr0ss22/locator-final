      ...
      if (isCanada) {
        ...
        try {
          ...
          for (let i = 1; i <= totalPages; i++) {
            ...
            if (pageData.data) {
              allFetchedPoints = [...allFetchedPoints, ...pageData.data];
              setLoadingProgress(allFetchedPoints.length);
            }
            await new Promise(resolve => setTimeout(resolve, 50)); 
          }
          setCanadaPoints(allFetchedPoints);
