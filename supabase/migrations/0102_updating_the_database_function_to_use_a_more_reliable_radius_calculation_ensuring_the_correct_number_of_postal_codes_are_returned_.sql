...
BEGIN
    ...
    WHERE cpc.geog IS NOT NULL AND ST_DWithin(cpc.geog, center_point, radius_meters, false); -- Switched to faster sphere calculation
...
BEGIN
    ...
    WHERE
        cpc.geog IS NOT NULL AND ST_DWithin(cpc.geog, center_point, radius_meters, false) -- Switched to faster sphere calculation
    ORDER BY
