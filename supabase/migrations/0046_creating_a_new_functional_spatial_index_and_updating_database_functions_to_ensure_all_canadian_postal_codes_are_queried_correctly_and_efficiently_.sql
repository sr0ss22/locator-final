...
-- Step 3: CRITICAL - Force the database to update its statistics to recognize and use the new index.
ANALYZE public.canadian_postal_codes;

-- Step 4: Recreate the radius search function to match the new partial index.
...
-- Step 5: Recreate the bounds search function similarly, ensuring it also uses the index.
