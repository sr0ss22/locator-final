CREATE OR REPLACE FUNCTION find_installers_for_public_locator(
...
RETURNS TABLE (
    -- All columns from the installers table
    id text,
    name text,
    address1 text,
    add2 text,
    ...
    country text,
    blinds_and_shades bigint,
    power_view integer,
    service_call integer,
    shutters bigint,
    email text,
    specialnote text,
    comments text,
    installer_vendor_id bigint,
    pip_certification_level text,
    shutter_certification_level text,
    powerview_certification text,
    sales_org text,
    draperies bigint,
    draperies_certification_level text,
    shipment integer,
    star_rating text,
    alta bigint,
    alta_motorization bigint,
    latitude double precision,
    longitude double precision,
    account_id uuid,
    hunter_douglas integer,
    carole integer,
    architectural integer,
    levolor integer,
    three_day_blinds integer,
    tall_window integer,
    fixture_displays integer,
    outdoor integer,
    high_voltage_hardwired integer,
    -- Additional calculated columns
    is_local_service_area boolean,
