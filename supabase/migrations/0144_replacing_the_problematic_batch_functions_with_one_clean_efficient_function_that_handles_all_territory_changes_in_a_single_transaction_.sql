...
DECLARE
  ...
  _summary TEXT;
BEGIN
  -- 1. Activate high-performance mode by bypassing the row-by-row audit log
  ...
  -- 3. Execute all deletions efficiently
  ...
  -- 4. Execute all status updates efficiently
  ...
  -- 5. Execute all new additions efficiently
