...
DECLARE
  ...
  _user_id UUID; -- New variable to safely hold the user ID
BEGIN
  ...
  INSERT INTO public.territory_audit_log (
    ...
    _change_type,
    _user_id, -- Use the safe variable here
  ...
  -- For AFTER triggers, the return value is ignored, but it's good practice to return the correct one.
